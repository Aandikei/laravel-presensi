...
<aside class="fixed left-0 top-0 z-20 hidden w-64 bg-white dark:bg-gray-800 md:block h-screen dark:border-r dark:border-gray-700">
    <div class="h-full overflow-y-auto py-4 text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 sidebar-scroll">
    ...
    <ul class="mt-6">
      ...
      <li class="relative px-6 py-3 rounded-lg dark:hover:bg-gray-700/30 transition-colors duration-150 {{ $isDashboard ? '' : '' }}">
        @if ($isDashboard)
          <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"
            aria-hidden="true"></span>
        @endif
    ...
    @role('admin')
      <div class="mt-4" x-data="{ open: (localStorage.getItem('sidebar-masterdata') || 'true') === 'true' }">
        ...
        {{-- Jurusan --}}
        @if(Auth::user()->getInstansi()->jenjang === 'SMA')
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
          @php $isJurusan = request()->routeIs('admin.jurusan.*'); @endphp
          @if ($isJurusan)
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"></span>
          @endif
          <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ $isJurusan ? 'text-gray-800 dark:text-gray-100 ' : '' }}"
        ...
        {{-- Terima Pindahan --}}
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
          @php $isPindah = request()->routeIs('admin.siswa.pindah.*'); @endphp
          @if ($isPindah)
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"></span>
          @endif
          <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ $isPindah ? 'text-gray-800 dark:text-gray-100 ' : '' }}"
            href="{{ route('admin.siswa.pindah.form-masuk') }}">
            <svg class="w-5 h-5" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path>
            </svg>
            <span class="ml-4">Terima Pindahan</span>
          </a>
        </li>
        {{-- Naik Kelas --}}
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
      ...
      <div class="mt-4" x-data="{ open: (localStorage.getItem('sidebar-monitoring') || 'true') === 'true' }">
        ...
        {{-- Laporan --}}
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
          @php $isLaporan = request()->routeIs('admin.laporan.*') && !request()->routeIs('admin.laporan.exports'); @endphp
          @if ($isLaporan)
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"></span>
          @endif
        ...
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
          @php $isExportSaya = request()->routeIs('admin.laporan.exports'); @endphp
          @if ($isExportSaya)
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"></span>
          @endif
          <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ $isExportSaya ? 'text-gray-800 dark:text-gray-100 ' : '' }}"
            href="{{ route('admin.laporan.exports') }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
            <span class="ml-4">Export Saya</span>
          </a>
        </li>
        </ul>
      </div>
    ...
    @role('kepala_sekolah')
      <div class="mt-4" x-data="{ open: (localStorage.getItem('sidebar-kasek') || 'true') === 'true' }">
        <button @click="open = !open; localStorage.setItem('sidebar-kasek', open)" class="flex items-center justify-between w-full px-6 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300">
          <span>Manajemen</span>
          <svg class="w-3 h-3 transition-transform duration-150" :class="{ 'rotate-180': open }" fill="currentColor" viewBox="0 0 20 20">
            <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"/>
          </svg>
    ...
    @role('wakil_kepala_sekolah')
      <div class="mt-4" x-data="{ open: (localStorage.getItem('sidebar-wakasek') || 'true') === 'true' }">
        <button @click="open = !open; localStorage.setItem('sidebar-wakasek', open)" class="flex items-center justify-between w-full px-6 py-2 text-xs font-semibold text-gray-400 uppercase tracking-wider hover:text-gray-600 dark:hover:text-gray-300">
    ...
    @role('guru|wali_kelas|kepala_sekolah|wakil_kepala_sekolah')
      <div class="mt-4" x-data="{ open: (localStorage.getItem('sidebar-mengajar') || 'true') === 'true' }">
        ...
        <li class="relative px-6 py-3 dark:hover:bg-gray-700/30 transition-colors duration-150 rounded-lg">
          @php $isExportSaya = request()->routeIs('guru.exports'); @endphp
          @if ($isExportSaya)
            <span class="absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg"></span>
          @endif
          <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ $isExportSaya ? 'text-gray-800 dark:text-gray-100 ' : '' }}"
            href="{{ route('guru.exports') }}">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4"/></svg>
            <span class="ml-4">Export Saya</span>
          </a>
        </li>
