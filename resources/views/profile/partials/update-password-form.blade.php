...
<form method="POST" action="{{ route('password.update') }}">
    ...
    <label class="block text-sm">
        ...
        <input
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 form-input @error('current_password') border-red-500 @enderror"
