<x-layouts.admin>
    ...
    <div class="container px-6 mx-auto">
        ...
        <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200 mb-4">Menu Kelola</h3>
        <div class="grid gap-4 md:grid-cols-2 xl:grid-cols-4 mb-6">
            <a href="{{ route('admin.guru.index') }}"
                ...
                <div>
                    <p class="font-semibold text-gray-700 dark:text-gray-200">Kelola Guru</p>
                    <p class="text-sm text-gray-500">Tambah, edit, hapus guru</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.siswa.index') }}"
                ...
                <div>
                    <p class="font-semibold text-gray-700 dark:text-gray-200">Kelola Siswa</p>
                    <p class="text-sm text-gray-500">Tambah, edit, hapus siswa</p>
                </div>
            </a>
            ...
            <a href="{{ route('admin.kelas.index') }}"
                ...
                <div>
                    <p class="font-semibold text-gray-700 dark:text-gray-200">Kelola Kelas</p>
                    <p class="text-sm text-gray-500">Atur kelas & wali kelas</p>
                </div>
            </a>
