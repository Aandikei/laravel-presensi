<x-layouts.admin>
    ...
    <div class="container px-6 mx-auto">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs">
            <div class="flex items-center justify-between px-5 py-4 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
                <h3 class="text-lg font-semibold text-gray-700 dark:text-gray-200">Daftar Sekolah</h3>
            ...
            <div class="w-full overflow-x-auto bg-white dark:bg-gray-800 p-4">
                <table id="tabel-sekolah" class="w-full whitespace-no-wrap">
                    <thead>
    ...
    <script>
        $(document).ready(function() {
            $('#tabel-sekolah').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('superadmin.sekolah.index') }}',
                columns: [
