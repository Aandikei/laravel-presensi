        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($kelas)
                ...
                ->addColumn('aksi', function ($row) {
                    $detail = '<a href="'.route('admin.kelas.detail', $row->id_kelas).'" title="Detail" class="text-purple-600 hover:text-purple-800 mr-2">
                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                        </svg>
                    </a>';
                    $edit = '<a href="'.route('admin.kelas.edit', $row->id_kelas).'" title="Edit" class="text-blue-600 hover:text-blue-800 mr-2">
                        <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
