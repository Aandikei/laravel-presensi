        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($jadwal)
                ...
                ->addColumn('aksi', function ($row) {
                    $edit = '<a href="' . route('admin.jadwal.edit', $row->id_jadwal) . '" title="Edit" class="text-blue-600 hover:text-blue-800 mr-2">
                    ...
                    $delete = '<form method="POST" action="' . route('admin.jadwal.destroy', $row->id_jadwal) . '" class="inline">
                        ...
                        <button type="submit" title="Hapus" class="text-red-600 hover:text-red-800" onclick="return confirm(\'Yakin hapus jadwal ini?\')">
                            <svg class="w-4 h-4 inline" fill="none" stroke="currentColor" viewBox="0 0 24 24">
